<template>
  <v-container fluid grid-list-md>
    ...
    <v-row><v-col :style="{ display: 'flex' }">
      ...
      <template v-slot:default="props">
        ...
        >
          ...
          <v-card
            ...
            :ripple="!currentServer || currentServer._id !== item._id"
            :hover="!currentServer || currentServer._id !== item._id"
            :color="currentServer && currentServer._id === item._id ? '#CFC' : '#FFF'"
          >
            <v-list-item two-line>
              <v-list-item-content>
                ...
                <v-list-item-subtitle>
                  ...
                  {{
                    currentServer && currentServer._id === item._id
                    ? ' - Currently Selected'
                    : ''
                  }}
                </v-list-item-subtitle>
